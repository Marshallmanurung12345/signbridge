...
## Fitur Utama
- 🔤 Indonesia → BISINDO : Terjemah teks ke visualisasi gesture per kata.
...
- 🎬 Modal Video: Putar video gerakan BISINDO untuk setiap kata yang diterjemahkan (video disimpan dalam folder `/videos`).
